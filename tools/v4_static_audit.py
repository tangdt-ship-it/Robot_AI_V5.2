#!/usr/bin/env python3
"""Static architecture/clean-release guardrails for Robot_AI_V4.2."""
...
require(text("VERSION").strip() == "4.2.0", "VERSION is not 4.2.0")
...
if errors:
    print("FAIL Robot_AI_V4.2 static audit")
    for err in errors:
        print(f" - {err}")
    sys.exit(1)
print(f"PASS Robot_AI_V4.2 static audit ({len(tool_names)} MCP tools checked)")
